...
if(!empty($arResult['APPLICANT']['city']) || !empty($arResult['APPLICANT']['legaladdress'])) $section->addText($blankSpace5.$arResult['APPLICANT']['city'].', '.$arResult['APPLICANT']['legaladdress'], 'common');
if(!empty($arResult['APPLICANT']['phone'])) $section->addText($blankSpace5.'Телефон:'.$arResult['APPLICANT']['phone'], 'common');
if(!empty($arResult['APPLICANT']['fax'])) $section->addText($blankSpace5.'Факс:'.$arResult['APPLICANT']['fax'], 'common');
if(!empty($arResult['APPLICANT']['telex'])) $section->addText($blankSpace5.'Телекс:'.$arResult['APPLICANT']['telex'], 'common');
if(!empty($arResult['APPLICANT']['email'])) $section->addText($blankSpace5.'E-mail:'.$arResult['APPLICANT']['email'], 'common');
...
$section->addText($blankSpace5.$country.',', 'common');
if(!empty($arResult['EXECUTOR']['city']) || !empty($arResult['EXECUTOR']['legaladdress'])) $section->addText($blankSpace5.$arResult['EXECUTOR']['city'].', '.$arResult['EXECUTOR']['legaladdress'], 'common');
if(!empty($arResult['EXECUTOR']['phone'])) $section->addText($blankSpace5.'Телефон:'.$arResult['EXECUTOR']['phone'], 'common');
if(!empty($arResult['EXECUTOR']['fax'])) $section->addText($blankSpace5.'Факс:'.$arResult['EXECUTOR']['fax'], 'common');
if(!empty($arResult['EXECUTOR']['telex'])) $section->addText($blankSpace5.'Телекс:'.$arResult['EXECUTOR']['telex'], 'common');
if(!empty($arResult['EXECUTOR']['email'])) $section->addText($blankSpace5.'E-mail:'.$arResult['EXECUTOR']['email'], 'common');
	...
	foreach ($arResult['PARTICIPANT'] as $counter=>$arItem){
			...
			switch ($arItem['type']) {
				case 1:
					...
					if(!empty($country)) $section->addText($blankSpace5.$country.',', 'common');
					if(!empty($arItem['city']) || !empty($arItem['legaladdress'])) $section->addText($blankSpace5.$arItem['city'].', '.$arItem['legaladdress'], 'common');
					if(!empty($arItem['phone'])) $section->addText($blankSpace5.'Телефон:'.$arItem['phone'], 'common');
					if(!empty($arItem['fax'])) $section->addText($blankSpace5.'Факс:'.$arItem['fax'], 'common');
					if(!empty($arItem['telex'])) $section->addText($blankSpace5.'Телекс:'.$arItem['telex'], 'common');
					if(!empty($arItem['email'])) $section->addText($blankSpace5.'E-mail:'.$arItem['email'], 'common');
		...
		break;
				case 2:
					...
					if(!empty($country)) $section->addText($blankSpace5."Гражданство: ".$country.',', 'common');
					if(!empty($arItem['workaddress'])) $section->addText($blankSpace5."Место работы: ".$arItem['workaddress'], 'common');
					if(!empty($arItem['particip'])) $section->addText($blankSpace5."Форма участия: ".$arItem['particip'], 'common');
